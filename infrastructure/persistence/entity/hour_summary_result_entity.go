...
type HourSummaryResultEntity struct {
	...
	RegionCode           string    `gorm:"column:region_code" json:"region_code"`                                      // 工作点所属区域
	IndustryCode         string    `gorm:"column:industry_code" json:"industry_code"`                                  // 工作点所属行业
	SubIndustryCode      string    `gorm:"column:sub_industry_code" json:"sub_industry_code"`                          // 工作点所属子行业
